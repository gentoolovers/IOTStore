...
extern const uint8_t RFID_READ_TYPE_19[2];
extern const uint8_t RFID_READ_CARD_20[2];
extern const uint8_t RFID_READ_MOD_TYPE_01[2];
extern const uint8_t RFID_READ_DATA_BLOCK_21[10];
extern const uint8_t RFID_WRITE_DATA_BLOCK_22_0[26];
extern const uint8_t RFID_WRITE_DATA_BLOCK_22_1[26];
#ifdef __cplusplus
}
#endif
