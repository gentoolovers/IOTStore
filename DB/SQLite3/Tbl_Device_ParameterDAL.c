...
bool Tbl_Device_ParameterAdd(Tbl_Device_Parameter _Tbl_Device_Parameter){
    ...
    char sql[256];
    sprintf(sql,"insert into Tbl_Device_Parameter (MinTem,MaxTem,MinHum,MaxHum,MinLit,MaxLit,TimeSet,IsSet) values(%f,%f,%f,%f,%f,%f,%d,%d)",_Tbl_Device_Parameter.MinTem,_Tbl_Device_Parameter.MaxTem,_Tbl_Device_Parameter.MinHum,_Tbl_Device_Parameter.MaxHum,_Tbl_Device_Parameter.MinLit,_Tbl_Device_Parameter.MaxLit,_Tbl_Device_Parameter.TimeSet,_Tbl_Device_Parameter.IsSet);
