...
bool Tbl_System_ParameterAdd(Tbl_System_Parameter _Tbl_System_Parameter){
    ...
    char sql[256];
    sprintf(sql,"insert into Tbl_System_Parameter (key,value) values('%s',%s')",_Tbl_System_Parameter.key,_Tbl_System_Parameter.value);
...
bool Tbl_System_ParameterModify(Tbl_System_Parameter _Tbl_System_Parameter){
    _Tbl_System_Parameter=Populate_Tbl_System_Parameter(_Tbl_System_Parameter);
    char sql[256];
    sprintf(sql,"update Tbl_System_Parameter set value='%s' where key='%s'",_Tbl_System_Parameter.value,_Tbl_System_Parameter.key);
    return exec_sql(sql)?true:false;
}
